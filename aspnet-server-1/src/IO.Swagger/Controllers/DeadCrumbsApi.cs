...
namespace IO.Swagger.Controllers
{
    ...
    public class DeadCrumbsController : ControllerBase
    {
        ...
        public virtual IActionResult PostBluetoothSync([FromRoute][Required]string username, 
            ...
            [FromRoute][Required]DateTime timeStamp)
        {
            //RSSI proximated distance less than or equal to this triggers synchronization 
            const float syncDistThreshold = 2;
            ...
            if (rssiDist <= syncDistThreshold)
            {           
                Func<double, double> toRadians = (degrees) => { return degrees * Math.PI / 180; };


                //Uses haversine’ distance formula to calculate distance between the two coordinates
                //See more at https://www.movable-type.co.uk/scripts/latlong.html
